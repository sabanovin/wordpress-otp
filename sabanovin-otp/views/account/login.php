			...
			<div class="mo_registration_divided_layout">
				<div class="mo_registration_table_layout">
					...
					<table class="mo_registration_settings_table">
						...
						<tr>
							<td>&nbsp;</td>
							<td><input type="submit" class="button button-primary button-large" value="Login"/>
								<a href="#goBackButton" class="button button-primary button-large">Go back to Registration</a>
						</tr>
					</table>
				</div>
			</div>
