...
echo '			<input type="hidden" name="option" value="mo_customer_validation_messages" />';
					...
					<tr>
						<td>
							<h2>'.mo_("CONFIGURE MESSAGES").'
								<span class="dashicons dashicons-arrow-up toggle-div" data-show="false" data-toggle="message_instruction"></span>
