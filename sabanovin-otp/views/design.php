...
echo    '   <table style="width:100%">
                <tr>
                    <td colspan="2">
                        ...
                        <span class="dashicons dashicons-arrow-up toggle-div" data-show="false" data-toggle="design_instructions"></span>
                        </h2><hr/>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="2">
                        <h3>
                            ...
                            <span style="float:right;margin-top:-10px;">
                                ...
                                <span class="dashicons dashicons-arrow-up toggle-div" data-show="false" data-toggle="default_popup"></span>
                            </span>
                        </h3> <hr>
                    </td>
                </tr>
...
echo                '         
                        ...
                        <td width="46%">
                                <iframe id="defaultPreview" name="defaultPreview" src="" 
                    ...
                    <td colspan="2">
                        <h3>
                            ...
                            <span style="float:right;margin-top:-10px;">
                                ...
                                <span class="dashicons dashicons-arrow-up toggle-div" data-show="false" data-toggle="userchoice_popup"></span>
                            </span>
                        </h3> <hr>
                    </td>
                </tr>
                    ...
                    <td colspan="2">
                        <h3>
                            ...
                            <span style="float:right;margin-top:-10px;">
                                ...
                                <span class="dashicons dashicons-arrow-up toggle-div" data-show="false" data-toggle="external_popup"></span>
                            </span>
                        </h3> <hr>
                    </td>
                </tr>
                    ...
                    <td colspan="2">
                        <h3>
                            ...
                            <span style="float:right;margin-top:-10px;">
                                ...
                                <span class="dashicons dashicons-arrow-up toggle-div" data-show="false" data-toggle="error_popup"></span>
                            </span>
                        </h3> <hr>
                    </td>
                </tr>
...
echo                '         
                        ...
                        <td width="46%">
                                <iframe id="errorPreview" name="errorPreview" src=""
                                    style="width:100%;margin-top:1%;border-radius: 4px;background-color: #d8d7d7;height:467px"></iframe>
                            </form>
                        </td>
                    </tr>
