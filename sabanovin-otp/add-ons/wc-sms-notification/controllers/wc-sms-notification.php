<?php 
	...
	$notification_settings 	= get_option('mo_wc_sms_notification_settings');
		...
		foreach ($notifications as $notification => $property) 
		{
			...
			echo '	<tr>
						...
						<td class="msn-table-list-name">
							...
							mo_draw_tooltip(MoAddOnMessages::showMessage($property->tooltipHeader)
											,MoAddOnMessages::showMessage($property->tooltipBody));
